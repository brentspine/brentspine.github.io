import { toasts, ToastColor, ToastPosition, ToastAnimation, ToastBuilder } from "./toasts-2.2.3.js";
...
function updateCodePreview() {
  ...
  const lines = [`import { ${Array.from(names).join(", ")} } from "./toasts-2.2.3.js";`, ``];
...
async function loadChangelog() {
  ...
  const url = "https://raw.githubusercontent.com/Brentspine/brents-toasts/main/docs/changelogs/2.2.3.md";
  try {
